...
يمكن للعملاء إرسال منارات دورية أغنى عبر الأسلوب `system-event`.
يستخدم تطبيق mac هذا للإبلاغ عن اسم المضيف وعنوان IP و`lastInputSeconds`.
...
## ملاحظة الاتصال البعيد/الأنفاق (عناوين loopback)

عندما يتصل عميل عبر نفق SSH / إعادة توجيه منفذ محلي،
قد يرى Gateway العنوان البعيد كـ `127.0.0.1`.
لتجنب الكتابة فوق عنوان IP جيد أبلغ عنه العميل،
