...
نقطة نهاية `/v1` الخاصة بالوكيل ويستخدم قائمة النماذج التي تهيئها هناك.
اختر هذا الخيار عندما تكون بالفعل تشغّل Copilot Proxy في VS Code أو تحتاج إلى
التوجيه عبره. يجب تمكين الإضافة والإبقاء على إضافة VS Code قيد التشغيل.
