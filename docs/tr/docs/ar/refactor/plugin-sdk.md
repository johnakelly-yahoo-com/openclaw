...
read_when:
  ...
  - ترحيل موصلات القنوات إلى مجموعة تطوير الإضافات/بيئة التشغيل
title: "إعادة هيكلة مجموعة تطوير الإضافات"
x-i18n:
...
- كل دالة في بيئة التشغيل تطابق تنفيذًا قائمًا في النواة (من دون تكرار).
...
- ترحيل Matrix إلى مجموعة التطوير + بيئة التشغيل.
...
- إضافة فحوص توافق مجموعة التطوير/الإصدار (بيئة التشغيل + semver لمجموعة التطوير).

## التوافق والإصدارات

- مجموعة التطوير: semver، منشورة، تغييرات موثّقة.
...
- توزيع أنواع بيئة التشغيل: ضمن مجموعة التطوير (أنواع فقط) أم ضمن النواة؟
