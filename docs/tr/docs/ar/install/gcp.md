...
8. دمج الملفات التنفيذية المطلوبة وبناء الصورة ثم التشغيل
...
| -------------------------- | --------------------------------- | ----------------------------- | ----------------------------- |
| تهيئة Gateway              | `/home/node/.openclaw/`           | ربط وحدة تخزين المضيف         | تتضمن `openclaw.json` والرموز |
| ملفات مصادقة النموذج       | `/home/node/.openclaw/`           | ربط وحدة تخزين المضيف         | رموز OAuth ومفاتيح API        |
| تهيئات Skills              | `/home/node/.openclaw/skills/`    | ربط وحدة تخزين المضيف         | حالة على مستوى Skill          |
| مساحة عمل الوكيل           | `/home/node/.openclaw/workspace/` | ربط وحدة تخزين المضيف         | الشيفرة وملفات الوكيل         |
| جلسة WhatsApp              | `/home/node/.openclaw/`           | ربط وحدة تخزين المضيف         | يحافظ على تسجيل الدخول عبر QR |
| حلقة مفاتيح Gmail          | `/home/node/.openclaw/`           | وحدة تخزين المضيف + كلمة مرور | يتطلب `GOG_KEYRING_PASSWORD`  |
| الملفات التنفيذية الخارجية | `/usr/local/bin/`                 | صورة Docker                   | يجب دمجها وقت البناء          |
