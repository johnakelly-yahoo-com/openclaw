...
عيّن الرموز عبر متغيرات البيئة (موصى به):
...
يمكن أيضًا تزويد الرموز عبر متغيرات البيئة:
...
## أمان الرسائل المباشرة (الاقتران)
